...
type MsgData struct {
	...
	SpecifyRecipient []string         `protobuf:"bytes,24,rep,name=specifyRecipient,proto3" json:"specifyRecipient,omitempty"` // 指定消息接受者。如：群消息指定接收用户；通知指定接收用户
	ReadUsers        []string         `protobuf:"bytes,25,rep,name=readUsers,proto3" json:"readUsers,omitempty"`               // 消息已读用户缓存
	OperateStatus    int32            `protobuf:"varint,26,opt,name=operateStatus,proto3" json:"operateStatus,omitempty"`      // 消息操作状态：0、无操作；1、可使用；2、已完成；3、已失效。此字段针对消息需要交互的场景使用，不需要交互的消息默认0
}
...
func (x *MsgData) GetSpecifyRecipient() []string {
	if x != nil {
...
func (x *MsgData) GetReadUsers() []string {
	if x != nil {
		return x.ReadUsers
	}
	return nil
...
func (x *MsgData) GetOperateStatus() int32 {
	if x != nil {
...
type UpdateItemTips struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UpdateItem map[string]*anypb.Any `protobuf:"bytes,1,rep,name=updateItem,proto3" json:"updateItem,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *UpdateItemTips) Reset() {
	*x = UpdateItemTips{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateItemTips) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateItemTips) ProtoMessage() {}

func (x *UpdateItemTips) ProtoReflect() protoreflect.Message {
	mi := &file_sdkws_sdkws_proto_msgTypes[59]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateItemTips.ProtoReflect.Descriptor instead.
func (*UpdateItemTips) Descriptor() ([]byte, []int) {
	return file_sdkws_sdkws_proto_rawDescGZIP(), []int{59}
}

func (x *UpdateItemTips) GetUpdateItem() map[string]*anypb.Any {
	if x != nil {
		return x.UpdateItem
	}
	return nil
...
type UpdateMsgsTips struct {
	...
	ConversationID string            `protobuf:"bytes,2,opt,name=conversationID,proto3" json:"conversationID,omitempty"`
	Seqs           []int64           `protobuf:"varint,3,rep,packed,name=seqs,proto3" json:"seqs,omitempty"`
	Msgs           []*UpdateItemTips `protobuf:"bytes,4,rep,name=msgs,proto3" json:"msgs,omitempty"`
	IsRefresh      bool              `protobuf:"varint,5,opt,name=isRefresh,proto3" json:"isRefresh,omitempty"`
}

func (x *UpdateMsgsTips) Reset() {
	*x = UpdateMsgsTips{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateMsgsTips) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateMsgsTips) ProtoMessage() {}

func (x *UpdateMsgsTips) ProtoReflect() protoreflect.Message {
	mi := &file_sdkws_sdkws_proto_msgTypes[60]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateMsgsTips.ProtoReflect.Descriptor instead.
func (*UpdateMsgsTips) Descriptor() ([]byte, []int) {
	return file_sdkws_sdkws_proto_rawDescGZIP(), []int{60}
}

func (x *UpdateMsgsTips) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *UpdateMsgsTips) GetConversationID() string {
	if x != nil {
		return x.ConversationID
	}
	return ""
...
func (x *UpdateMsgsTips) GetSeqs() []int64 {
	if x != nil {
		return x.Seqs
	}
	return nil
...
func (x *UpdateMsgsTips) GetMsgs() []*UpdateItemTips {
	if x != nil {
		return x.Msgs
	}
	return nil
...
func (x *UpdateMsgsTips) GetIsRefresh() bool {
	if x != nil {
		return x.IsRefresh
	}
	return false
...
var file_sdkws_sdkws_proto_rawDesc = []byte{
	...
	0x44, 0x22, 0xca, 0x03, 0x0a, 0x0f, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x46,
	...
	0x02, 0x65, 0x78, 0x12, 0x4d, 0x0a, 0x10, 0x6e, 0x65, 0x65, 0x64, 0x56, 0x65, 0x72, 0x69, 0x66,
	...
	0x6f, 0x6e, 0x12, 0x49, 0x0a, 0x0e, 0x6c, 0x6f, 0x6f, 0x6b, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x4f, 0x70, 0x65,
	...
	0x6f, 0x6f, 0x6b, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x4f, 0x0a,
	0x11, 0x61, 0x70, 0x70, 0x6c, 0x79, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x46, 0x72, 0x69, 0x65,
	0x6e, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x4f, 0x70, 0x65, 0x6e, 0x49,
	...
	0xfa, 0x01, 0x0a, 0x0a, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20,
	...
	0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3c, 0x0a, 0x0a, 0x66, 0x72, 0x69, 0x65,
	0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x4f,
	...
	0x65, 0x78, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x65, 0x78, 0x22, 0xed, 0x01, 0x0a,
	...
	0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x48, 0x0a, 0x0d,
	...
	0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x0e, 0x0a, 0x02,
	0x65, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x65, 0x78, 0x22, 0x99, 0x03, 0x0a,
	0x0c, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a,
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x65, 0x78, 0x22, 0x9f, 0x01, 0x0a, 0x14, 0x50,
	...
	0x22, 0x9e, 0x07, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06,
	...
	,
	...
	0x28, 0x09, 0x52, 0x0a, 0x6a, 0x73, 0x6f, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0xc8,
	...
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x22, 0x6b, 0x0a, 0x11, 0x46, 0x72,
	...
	,
	...
	0x49, 0x44, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x65, 0x71, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x03,
	0x52, 0x04, 0x73, 0x65, 0x71, 0x73, 0x12, 0x36, 0x0a, 0x04, 0x6d, 0x73, 0x67, 0x73, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x4f, 0x70, 0x65, 0x6e, 0x49, 0x4d, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2e, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x49, 0x74, 0x65, 0x6d, 0x54, 0x69, 0x70, 0x73, 0x52, 0x04, 0x6d, 0x73, 0x67, 0x73, 0x12, 0x1c,
	0x0a, 0x09, 0x69, 0x73, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x09, 0x69, 0x73, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x22, 0x64, 0x0a, 0x0e,
...
var file_sdkws_sdkws_proto_goTypes = []interface{}{
	...
	(*UpdateItemTips)(nil),                // 60: OpenIMServer.sdkws.UpdateItemTips
	(*UpdateMsgsTips)(nil),                // 61: OpenIMServer.sdkws.UpdateMsgsTips
	...
	nil,                                   // 74: OpenIMServer.sdkws.UpdateItemTips.UpdateItemEntry
...
var file_sdkws_sdkws_proto_depIdxs = []int32{
	...
	74, // 72: OpenIMServer.sdkws.UpdateItemTips.updateItem:type_name -> OpenIMServer.sdkws.UpdateItemTips.UpdateItemEntry
	60, // 73: OpenIMServer.sdkws.UpdateMsgsTips.msgs:type_name -> OpenIMServer.sdkws.UpdateItemTips
	...
	77, // 78: OpenIMServer.sdkws.UpdateItemTips.UpdateItemEntry.value:type_name -> google.protobuf.Any
